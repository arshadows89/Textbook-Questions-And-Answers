...
def rock_paper_scissors_game
  ...
  def winner
    if  (@answer.downcase == 'rock') && (@cpu_answer.downcase == 'paper')
      puts 'YOU LOSE'
    elsif (@answer.downcase == 'paper') && (@cpu_answer.downcase == 'rock')
      puts 'WINNER'
    elsif (@answer.downcase == 'paper') && (@cpu_answer.downcase == 'scissors')
      puts 'You Lose'
    elsif (@answer.downcase == 'scissors') && (@cpu_answer.downcase == 'paper')
      puts 'WINNER'
    elsif (@answer.downcase == 'scissors') && (@cpu_answer.downcase == 'rock')
      puts 'You Lose'
    elsif (@answer.downcase == 'rock') && (@cpu_answer.downcase == 'scissors')
      puts 'Winner'
    else
